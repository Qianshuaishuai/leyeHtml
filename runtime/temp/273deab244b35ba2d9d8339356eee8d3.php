<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:34:"./views/admin/pc/notice/post.phtml";i:1541935409;s:59:"/www/wwwroot/leye/public/views/admin/pc/common/header.phtml";i:1541935409;s:60:"/www/wwwroot/leye/public/views/admin/pc/common/sidebar.phtml";i:1592312768;s:56:"/www/wwwroot/leye/public/views/admin/pc/notice/nav.phtml";i:1541935409;s:57:"/www/wwwroot/leye/public/views/admin/pc/notice/tabs.phtml";i:1541935409;s:59:"/www/wwwroot/leye/public/views/admin/pc/common/footer.phtml";i:1592313406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="title" value="<?php echo !empty($item['title'])?$item['title']:''; ?>" placeholder="请输入公告的标题">
                                        </div>
                                    </div>
                                    <?php echo tpl_ueditor(['name'=>'detail','value'=>!empty($item['title'])?$item['title']:'']); ?>
                                    <div class="form-group">
