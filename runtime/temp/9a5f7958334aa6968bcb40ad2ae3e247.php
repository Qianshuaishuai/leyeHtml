<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./views/home/mobile/invite/gold.phtml";i:1592363015;s:62:"/www/wwwroot/leye/public/views/home/mobile/common/header.phtml";i:1541935409;s:62:"/www/wwwroot/leye/public/views/home/mobile/common/footer.phtml";i:1592421926;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
        ...
        layui.use('flow', function(){
            ...
            flow.load({
                ...
                ,done: function(page, next){
                    var lis = [];
                    $.get('/home/invite/gold_ajax/page/'+page, function(res){
                        layui.each(res.data.data, function(index, item){
                            $("#flow").append('<li><b><i>'+item.num+'元</i><time>'+item.create_time+'</time></b><p>任务ID：'+item.task_id+'<span>'+item.remark+'</span></p>    </li>');
                        });
