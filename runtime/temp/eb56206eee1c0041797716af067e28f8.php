<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./views/home/mobile/account/withdrawlog.phtml";i:1592363015;s:62:"/www/wwwroot/leye/public/views/home/mobile/common/header.phtml";i:1541935409;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
        ...
        layui.use('flow', function(){
            ...
            flow.load({
                    ...
                    ,done: function(page, next){
                            var lis = [];
                            $.get('/home/account/withdrawlog_ajax/page/'+page, function(res){
                                layui.each(res.data.data, function(index, item){
                                    ...
                                    $("#flow").append('<li><b><i>'+item.credit2+'元</i><time>'+item.create_time+'</time></b><p>'+item.account+'<span>'+status+''+(item.note ? '管理员回复：'+item.note : '')+'</span></p>    </li>');
                                });
