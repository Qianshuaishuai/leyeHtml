                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $item['have_money']; ?>元
                                                    </td>
                                                    <td><?php if($item['is_effect'] > 0): ?>生效<?php else: ?>未生效<?php endif; ?></td>
                                                    <td><?php echo $item['repay_1']; ?></td>
                                                    <td><?php echo $item['repay_2']; ?></td>
                                                    <td><?php echo $item['repay_3']; ?></td>
                                                   <td><?php echo $item['butie']; ?></td>
                                                    <td>
                                                        <a href="<?php echo U('level_edit', 'id=' . $item['id']); ?>" class="btn btn-sm btn-success">编辑</a>
                                                    </td>
                                                </tr>
