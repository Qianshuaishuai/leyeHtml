                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">级别名称</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="title" value="<?php echo $item['title']; ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">开通所需金额</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="have_money" value="<?php echo $item['have_money']; ?>" placeholder="需要修改密码时请输入，否则请留空">
                                        </div>
                                    </div>
                                   
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">一级返佣</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="repay_1" value="<?php echo $item['repay_1']; ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">二级返佣</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="repay_2" value="<?php echo $item['repay_2']; ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">三级返佣</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="repay_3" value="<?php echo $item['repay_3']; ?>" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">补贴</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="butie" value="<?php echo $item['butie']; ?>" placeholder="">
                                        </div>
                                    </div>

                                    
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否生效</label>
                                        <div class="col-sm-6 col-xs-12">
                                            <label class="radio-inline">
                                                <input type="radio" name="is_effect" value="1" <?php echo !empty($item['is_effect'])?'checked':''; ?>>
                                                正常
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="is_effect" value="0" <?php echo !empty($item['is_effect'])?'':'checked'; ?>>
                                                禁用
                                            </label>
                                        </div>
                                    </div>
