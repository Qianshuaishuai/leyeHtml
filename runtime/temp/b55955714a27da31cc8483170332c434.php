<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./views/home/mobile/auth/login.phtml";i:1593759907;}*/ ?>
<!DOCTYPE HTML>
<html>
	...
	<body class="login-panel">
		<div class="site-header loginTitle">
			...
			<div class="tit-name" style="padding:0;"><img src="<?php echo to_media(!empty($site['logo'])?$site['logo']:'乐业家国任务网'); ?>" /></div>
		</div>
		<div class="main-cont">
            <form id="login_form">
